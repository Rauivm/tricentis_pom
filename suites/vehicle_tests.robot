...
#Test Template    Criar seguro para 'automobile'
...
*** Test Cases ***
CT01 - BMW 15000km
    Criar seguro para 'automobile'    ${vehicle_automobile_data}[0]


CT02 - Honda 5000km
    Criar seguro para 'motorcycle'    ${vehicle_motorcycle_data}[0]
